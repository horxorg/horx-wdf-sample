...
public class AssetApiController {
    ...
    public PaginationResult<Asset> paginationQuery(@ArgEntity AssetQuery query, PaginationParam paginationParam) {
        PaginationResult<Asset> paginationResult = assetService.paginationQuery(query, paginationParam);
